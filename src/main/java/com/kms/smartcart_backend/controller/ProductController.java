...
public class ProductController {
    ...
    @PostMapping(value = "/chatgpt/image-processing", consumes = MediaType.MULTIPART_FORM_DATA_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping("/naver/lowest-price")
